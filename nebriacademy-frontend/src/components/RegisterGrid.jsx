...
function RegisterGrid({ tipo }) {
  ...
  return (
    <div className={tipo === "alumnonebrija" ? "login-grid" : "register-grid-externo"}>
      <div className={tipo === "alumnonebrija" ? "formulario-login-contenedor" : "formulario-register-contenedor"}>
        <h2>Regístrate</h2>
        <form className={tipo === "alumnonebrija" ? "formulario-login" : "formulario-register"} onSubmit={handleRegister}>
          ...
          <button type="submit">{tipo === "profesor" ? "Completar Registro" : "Registrarse"}</button>
        </form>
